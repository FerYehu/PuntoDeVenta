...
public class FrmLogin extends javax.swing.JFrame {
    ...
    public FrmLogin() {
        ...
        //this.setSize(new Dimension(700,800)); define la dimension de la ventana
    ...
    private void Login(){
        if (!txt_usuario.getText().isEmpty() && !txt_password.getText().isEmpty()){
            ...
            usuario.setNombreUs(txt_usuario.getText().trim());
            usuario.setPasswordUs(txt_password.getText().trim());
