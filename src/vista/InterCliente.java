...
public class InterCliente extends javax.swing.JInternalFrame {
    ...
    private void jButton1_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_GuardarActionPerformed
        ...
        if (!txt_nombre.getText().isEmpty() || txt_rfc.getText().isEmpty() || txt_telefono.getText().isEmpty() || txt_idusuarioalta.getText().isEmpty())
        {
            //JOptionPane.showMessageDialog(null, "Registro correcto");

            if (!controlCliente.existeCliente(txt_idcliente.getText().trim()))
            {

                //cliente.setIdCliente(txt_idcliente.getText().trim());
                cliente.setNombre(txt_nombre.getText().trim());
                cliente.setRFC(txt_rfc.getText().trim());
                cliente.setEmail(txt_email.getText().trim());
                cliente.setDireccion(txt_direccion.getText().trim());
                //cliente.setTelefono(txt_telefono.getText().trim());
                cliente.setEstatus(txt_estatus.getText().trim());
                ...
                if (controlCliente.guardar(cliente))
                {
                    ...
                    txt_idusuarioalta.setBackground(Color.green);
            ...
            } else
            {
                ...
                txt_rfc.setBackground(Color.white);
                txt_telefono.setBackground(Color.white);
                txt_idusuarioalta.setBackground(Color.white);
            }
        } else
        {
            ...
            txt_idusuarioalta.setBackground(Color.red);
        }
