...
public class InterProducto extends javax.swing.JInternalFrame {
    ...
    private void jButton1_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_GuardarActionPerformed
        ...
        if (txt_nombre.getText().isEmpty()  || txt_precio.getText().isEmpty()  || txt_proovedor.getText().isEmpty()  || txt_stock.getText().isEmpty()  ) {
            ...
            txt_idproducto.setBackground(Color.red);
            txt_descripcion.setBackground(Color.red);
            txt_proovedor.setBackground(Color.red);
            txt_estatus.setBackground(Color.red);
        }else{
                ...
                try{
                    ...
                    */
                    ...
                    if (controlProducto.guardar(producto))
                    {
                        ...
                        txt_idproducto.setBackground(Color.green);
                        txt_proovedor.setBackground(Color.green);
                        txt_estatus.setBackground(Color.green);
